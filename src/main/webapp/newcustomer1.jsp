...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="customeradd1.do">
      <p>证件类型：${type}</p>
      <p>证件号码：${number}</p>
      <p>姓名：<input type="text" name="name" size="20" value="Tom"></p>
      ...
      <p>联系地址：<input type="text" name="address" size="20" value="akjs askfa asjkfsa"></p>
      <p>　</p>
