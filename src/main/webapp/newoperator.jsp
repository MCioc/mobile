...
$(function(){
	$("#pwd1").blur(function(){
		if($("#pwd").val()!=$(this).val()){
			$("#span_pwd1").html("密码不一致".fontcolor("red"));
		}else{
			$("#span_pwd1").html("密码一致".fontcolor("green"));
		}
	})
})
...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
    ...
    <TD width=173 bgColor=#c9d3e9 rowSpan=2>
      <TABLE cellSpacing=0 cellPadding=0 width=173 border=0>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="getchargename.do">配置业务费用</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
            src="images/blank.gif" width=1 border=0></TD></TR>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="operatoradd.do">
      <p>登录ID：<input type="text" name="ID" size="20" value="A00000001"></p>
      <p>姓 名：<input type="text" name="name" size="20" value="张三"></p>
      <p>密码：<input type="password" name="pwd" size="20" value="******" id="pwd"></p>
      <p>密码确认：<input type="password" name="pwd1" size="20" value="******" id="pwd1"><span id="span_pwd1"></span></p>
      <p>是否管理员：<input type="radio" value="1" checked name="YN">是&nbsp;&nbsp;&nbsp; 
      <input type="radio" name="0" value="N">否</p>
